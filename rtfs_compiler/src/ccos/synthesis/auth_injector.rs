use crate::ast::{Expression, Keyword, Literal};
...
impl AuthInjector {
    ...
    pub fn generate_auth_injection_code(
        ...
        let mut call_args = vec![
            ...
            (
                crate::ast::MapKey::Keyword(Keyword("type".to_string())),
                Expression::Literal(Literal::Keyword(Keyword(auth_type.to_string()))),
            ),
            (
                crate::ast::MapKey::Keyword(Keyword("token".to_string())),
                Expression::Symbol(crate::ast::Symbol(token_param_name.to_string())),
            ),
        ];
