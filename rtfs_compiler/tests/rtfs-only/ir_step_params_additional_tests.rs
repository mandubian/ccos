...
fn step_params_success_smoke() {
    ...
    let map_node = IrNode::Map {
        ...
        entries: vec![IrMapEntry {
            ...
            value: IrNode::Literal {
                id: 103,
                value: rtfs_compiler::ast::Literal::Integer(7),
    ...
    let outcome = runtime
        .execute_program(&program, &mut module_registry)
...
fn step_params_eval_failure_cleanup() {
    ...
    let bad_key = IrNode::Vector {
        id: 201,
        elements: vec![IrNode::Literal {
            id: 202,
            value: rtfs_compiler::ast::Literal::Integer(1),
            ir_type: rtfs_compiler::ir::core::IrType::Int,
            source_location: None,
        }],
        ir_type: rtfs_compiler::ir::core::IrType::Vector(Box::new(
            rtfs_compiler::ir::core::IrType::Int,
        )),
        source_location: None,
    };
    ...
    let map_node = IrNode::Map {
        ...
        entries: vec![IrMapEntry {
            ...
            value: IrNode::Literal {
                id: 204,
                value: rtfs_compiler::ast::Literal::Integer(9),
                ir_type: rtfs_compiler::ir::core::IrType::Int,
                source_location: None,
            },
        }],
    ...
    let body = vec![IrNode::Literal {
        id: 210,
        value: rtfs_compiler::ast::Literal::Integer(0),
        ir_type: rtfs_compiler::ir::core::IrType::Int,
        source_location: None,
    }];
...
fn step_no_params_executes_body() {
    ...
    let body = vec![IrNode::Literal {
        id: 310,
        value: rtfs_compiler::ast::Literal::Integer(55),
        ir_type: rtfs_compiler::ir::core::IrType::Int,
        source_location: None,
    }];
    let step = IrNode::Step {
        id: 320,
        name: "s_no_params".to_string(),
        expose_override: None,
        context_keys_override: None,
        params: None,
        body,
