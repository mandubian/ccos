...
fn test_union_type_validation_success() {
    ...
    assert!(validator
        .validate_value(&Value::Integer(42), &union_type)
        .is_ok());

    // Should accept string
    assert!(validator
        .validate_value(&Value::String("hello".to_string()), &union_type)
        .is_ok());
}
...
fn test_union_type_validation_failure() {
    ...
    assert!(validator
        .validate_value(&Value::Boolean(true), &union_type)
        .is_err());

    // Should reject float
    assert!(validator
        .validate_value(&Value::Float(3.14), &union_type)
        .is_err());
...
fn test_union_type_with_complex_types() {
    ...
    assert!(validator
        .validate_value(&Value::Map(test_map), &complex_union)
        .is_ok());
    ...
    assert!(validator
        .validate_value(&Value::Map(bad_map), &complex_union)
        .is_err());
}
...
fn test_union_type_with_multiple_primitives() {
    ...
    assert!(validator
        .validate_value(&Value::Integer(42), &multi_union)
        .is_ok());
    assert!(validator
        .validate_value(&Value::String("test".to_string()), &multi_union)
        .is_ok());
    assert!(validator
        .validate_value(&Value::Boolean(true), &multi_union)
        .is_ok());
    assert!(validator
        .validate_value(&Value::Float(3.14), &multi_union)
        .is_ok());
...
fn test_union_type_nested_in_map() {
    ...
    assert!(validator
        .validate_value(&Value::Map(map_with_int), &map_with_union)
        .is_ok());
    ...
    assert!(validator
        .validate_value(&Value::Map(map_with_string), &map_with_union)
        .is_ok());
    ...
    assert!(validator
        .validate_value(&Value::Map(map_with_bool), &map_with_union)
        .is_err());
}
...
fn test_union_type_with_nil() {
    ...
    // Should accept integer
    assert!(validator
        .validate_value(&Value::Integer(42), &union_with_nil)
        .is_ok());

    // Should accept nil
    assert!(validator
        .validate_value(&Value::Nil, &union_with_nil)
        .is_ok());

    // Should reject string
    assert!(validator
        .validate_value(&Value::String("test".to_string()), &union_with_nil)
        .is_err());
}
