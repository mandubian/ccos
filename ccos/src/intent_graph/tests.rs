...
mod tests {
    ...
    use crate::intent_graph::core::IntentGraph;
    use crate::intent_graph::virtualization::VirtualizationConfig;
    use crate::intent_storage::IntentFilter;
    use crate::types::{EdgeType, IntentStatus, StorableIntent};
    ...
    async fn test_weighted_edges() {
        ...
        let edge1 = crate::intent_graph::storage::Edge::new(
            intent1_id.clone(),
            intent2_id.clone(),
            EdgeType::DependsOn,
        )
        ...
        let edge2 = crate::intent_graph::storage::Edge::new(
            intent1_id.clone(),
            intent3_id.clone(),
            EdgeType::RelatedTo,
        )
