...
use super::super::types::{EdgeType, IntentId, StorableIntent};
...
impl IntentGraphStorage {
    ...
    pub async fn get_intent(
        &self,
        intent_id: &IntentId,
    ) -> Result<Option<StorableIntent>, RuntimeError> {
        self.storage
    ...
    pub async fn get_edges_for_intent(
        &self,
        intent_id: &IntentId,
    ) -> Result<Vec<Edge>, RuntimeError> {
        self.storage
    ...
    pub async fn get_related_intents(
        &self,
        intent_id: &IntentId,
    ...
    pub async fn get_dependent_intents(
        &self,
        intent_id: &IntentId,
    ) -> Result<Vec<StorableIntent>, RuntimeError> {
        let edges = self
    ...
    pub async fn get_conflicting_intents(
        &self,
        intent_id: &IntentId,
    ) -> Result<Vec<StorableIntent>, RuntimeError> {
        let edges = self
    ...
    pub fn get_intent_sync(&self, intent_id: &IntentId) -> Option<StorableIntent> {
        ...
        futures::executor::block_on(self.get_intent(intent_id))
            .ok()
            .flatten()
    }
    ...
    pub fn get_connected_intents_sync(&self, intent_id: &IntentId) -> Vec<IntentId> {
        let edges =
            futures::executor::block_on(self.get_edges_for_intent(intent_id)).unwrap_or_default();
...
impl crate::storage::Archivable for Edge {
