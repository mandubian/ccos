...
pub fn generate_planner_via_arbiter(
    ...
    format!(
        concat!(
            ...
            "- Use RTFS 2.0 keyword syntax for properties (e.g., `:name \"...\"` instead of `(name \"...\")`).\n",
            ...
            "- REQUIRED Properties: `:name`, `:description`, `:version`, `:implementation`.\n",
            "- OPTIONAL Properties: `:meta`, `:input-schema`, `:output-schema`.\n\n",
