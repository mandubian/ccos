                ...
                DiscoveredEndpoint {
                    ...
                    parameters: vec![
                        EndpointParameter {
                            ...
                            param_type: TypeExpr::Primitive(rtfs::ast::PrimitiveType::String),
                            required: true,
                        ...
                        EndpointParameter {
                            ...
                            param_type: TypeExpr::Primitive(rtfs::ast::PrimitiveType::Bool),
                            required: false,
            ...
            endpoints: vec![
                ...
                DiscoveredEndpoint {
                    ...
                    input_schema: Some(TypeExpr::Map {
                        entries: vec![
                            ...
                            MapTypeEntry {
                                ...
                                value_type: Box::new(TypeExpr::Primitive(rtfs::ast::PrimitiveType::Float)),
                                optional: true,
                            },
                            MapTypeEntry {
                    ...
                    parameters: vec![
                        ...
                        EndpointParameter {
                            name: "lat".to_string(),
                            param_type: TypeExpr::Primitive(rtfs::ast::PrimitiveType::Float),
                            required: false,
                            location: "query".to_string(),
                ...
                DiscoveredEndpoint {
                    ...
                    parameters: vec![
                        ...
                        EndpointParameter {
                            name: "cnt".to_string(),
                            param_type: TypeExpr::Primitive(rtfs::ast::PrimitiveType::Int),
                            required: false,
                            location: "query".to_string(),
