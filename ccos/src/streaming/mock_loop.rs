use crate::streaming::{
    McpStreamingProvider, StreamTransport, StreamTransportArgs,
};
...
pub async fn run_mock_stream_loop(
    ...
    for i in 0..total {
        let chunk = Value::Map({
            ...
            m.insert(
                rtfs::ast::MapKey::Keyword(rtfs::ast::Keyword("seq".into())),
                Value::Integer(i as i64),
            );
            m.insert(
                rtfs::ast::MapKey::Keyword(rtfs::ast::Keyword("payload".into())),
