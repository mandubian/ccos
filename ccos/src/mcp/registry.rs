...
//! to discover available MCP servers and their capabilities.
//!
...
///
/// Queries the official MCP Registry API to find servers that provide
/// specific capabilities. This is separate from discovering tools FROM
/// a known server (which is handled by the discovery session manager).
