...
use crate::working_memory::boundaries::{Boundary, BoundaryType};
...
use crate::working_memory::types::WorkingMemoryEntry;
...
impl ContextHorizonManager {
    ...
    pub fn fetch_wisdom_from_working_memory(
        &self,
        boundaries: &[Boundary],
    ) -> Result<Vec<crate::working_memory::types::WorkingMemoryEntry>, RuntimeError> {
        let wm = self
            .working_memory
            .lock()
    ...
    fn persist_wisdom_to_working_memory(
        ...
        let entry = WorkingMemoryEntry {
            ...
            timestamp_s,
            approx_tokens,
            meta: crate::working_memory::types::WorkingMemoryMeta {
                action_id: None,
                plan_id: None,
                intent_id: None,
                step_id: None,
