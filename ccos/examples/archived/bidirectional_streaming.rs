...
use rtfs::runtime::streaming::{
    StreamConfig, StreamHandle, StreamType, StreamingCapability, StreamingProvider,
};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let simple_provider: StreamingProvider =
        Arc::new(SimpleStreamCapability::new("websocket-chat".to_string()));
