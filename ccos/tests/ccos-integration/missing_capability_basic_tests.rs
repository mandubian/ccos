...
async fn test_concurrent_missing_capability_resolution() {
    ...
    println!(
        "   📊 Final stats: pending={}, in_progress={}, failed={}",
        stats.pending_count, stats.in_progress_count, stats.failed_count
    );
}
...
async fn test_error_handling_and_edge_cases() {
    ...
    // Note: older tests omitted the feature flag arg; add default above
        ...
        let _ = resolver.handle_missing_capability(
            ...
            vec![
                ...
                Value::Map(std::collections::HashMap::from([
                    (
                        rtfs::ast::MapKey::String("key1".to_string()),
                        Value::String(format!("value1_{}", i)),
                    ),
                    (
                        rtfs::ast::MapKey::String("key2".to_string()),
