...
use rtfs::ccos::arbiter::plan_generation::{
...
use rtfs::ccos::orchestrator::{self};
use rtfs::ccos::types::IntentStatus;
use rtfs::ccos::types::{Intent, StorableIntent};
use rtfs::runtime::security::RuntimeContext;
use rtfs::runtime::stdlib::register_default_capabilities;
...
async fn stub_plan_generation_and_execution_works() {
    ...
    let orchestrator = orchestrator::Orchestrator::new(
        ...
        intent_graph.clone(),
        marketplace.clone(),
        Arc::new(rtfs::ccos::plan_archive::PlanArchive::new()),
    );
    ...
    if exec.success {
        ...
        let has_plan_started = actions
            .iter()
            .any(|a| a.action_type == rtfs::ccos::types::ActionType::PlanStarted);
        let has_cap_call = actions
            .iter()
            .any(|a| a.action_type == rtfs::ccos::types::ActionType::CapabilityCall);
        ...
        let has_plan_paused = actions
            .iter()
            .any(|a| a.action_type == rtfs::ccos::types::ActionType::PlanPaused);
        assert!(
            has_plan_paused,
